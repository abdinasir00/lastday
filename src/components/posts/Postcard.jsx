...
import { likePost, unlikePost, fetchComments, 
  createComment, deletePost, deleteComment } from '../../store/slices/PostSlices';
...
function PostCard({ post, showDeleteButton = false }) {
 ...
 const comments = useSelector((state) => state.post?.commentsByPost?.[postId] || []);
const commentsStatus = useSelector((state) => state.post?.commentsStatus?.[postId] || "idle");
